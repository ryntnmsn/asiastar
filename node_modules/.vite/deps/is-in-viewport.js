...
import_jquery.default.extend(import_jquery.default.expr.pseudos || import_jquery.default.expr[":"], {
  // if $.expr.createPseudo is available, use it
  "in-viewport": import_jquery.default.expr.createPseudo ? import_jquery.default.expr.createPseudo(function(argsString) {
...
import_jquery.default.fn.isInViewport = function(options) {
  return this.filter(function(i, el) {
    return isInViewport(el, options);
  });
};
import_jquery.default.fn.run = run;
function run(args) {
  var this$1 = this;
  ...
  args.forEach(function(arg) {
    if (typeof arg !== "function") {
      ...
      [].slice.call(this$1).forEach(function(t) {
        return arg.call((0, import_jquery.default)(t));
      });
    }
  });
  return this;
...
function getScrollbarWidth(viewport) {
  var el = (0, import_jquery.default)("<div></div>").css({
    width: "100%"
  });
  viewport.append(el);
...
function isInViewport(element, options) {
  ...
  var left = ref.left;
  var right = ref.right;
  var settings = import_jquery.default.extend({
    tolerance: 0,
    viewport: window
  }, options);
  var isVisibleFlag = false;
  var $viewport = settings.viewport.jquery ? settings.viewport : (0, import_jquery.default)(settings.viewport);
  if (!$viewport.length) {
    console.warn("isInViewport: The viewport selector you have provided matches no element on page.");
    console.warn("isInViewport: Defaulting to viewport as window");
    $viewport = (0, import_jquery.default)(window);
  }
...
function getSelectorArgs(argsString) {
  if (argsString) {
    ...
    return {
      ...
      viewport: args[1] ? (0, import_jquery.default)(args[1].trim()) : void 0
    };
  }
  return {};
}
...
is-in-viewport/lib/isInViewport.es6.js:
  (**
   * @author  Mudit Ameta
