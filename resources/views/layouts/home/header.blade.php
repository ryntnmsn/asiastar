<div class="w-full p-5 top-0 fixed z-[100] montserrat">
    <div wire:ignore class="w-full rounded-xl ">
        <div x-data="{ open: false }" class="flex flex-col md:items-center md:justify-between md:flex-row ">
            <div class="flex flex-row items-center justify-between">
                <a href="#" class="font-semibold tracking-widest text-slate-50 uppercase rounded-lg">LOGO HERE</a>
            ...
            <nav :class="{'flex': open, 'hidden': !open}" class=" items-center flex-col flex-grow gap-10 hidden md:flex md:justify-end md:flex-row">
                ...
                <div class="flex gap-2">
                    {{-- Languages --}}
                    <div @click.away="open = false" class="relative" x-data="{ open: false }">
                        <button @click="open = !open" class="text-slate-50 flex flex-row gap-1 items-center w-full text-left hover:bg-sky-600 rounded-full text-sm p-2">
                            <span>
                    ...
                    <div>
                        <button id="theme-toggle" type="button" class="text-slate-50 hover:bg-sky-600 focus:outline-none focus:ring-0 rounded-full text-sm p-2">
