                ...
                <div class="search-box border-0 lg:border-b border-white/[.30]">
                    <div class="flex items-center h-full">
                        <i class="flex items-center h-full gap-2">
                            <button data-modal-target="global-search-modal" data-modal-toggle="global-search-modal" class="text-slate-50 text_header hover:bg-amber-400 focus:outline-none focus:ring-0 rounded-full text-sm p-2">
