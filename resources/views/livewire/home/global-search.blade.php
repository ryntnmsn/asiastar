<div>
    <!-- Main modal Search-->
<div wire:ignore.self id="global-search-modal" tabindex="-1" aria-hidden="true" class="duration-300 ease-in-out hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 bottom-0 z-[999] justify-center items-center w-full md:inset-0 max-h-full backdrop-blur-xl">
    <div id="modalAnimation" class="relative p-4 w-full h-full max-h-full">
        ...
        <div class="relative bg-white rounded-xl shadow h-full opacity-75 backdrop-blur-xl overflow-auto">
            ...
            <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t">
                ...
                <button wire:click="resetGlobalSearch" type="button" class="text-slate-400 bg-transparent hover:bg-slate-200 hover:text-slate-600 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center" data-modal-hide="global-search-modal">
            ...
            <div class="p-4 md:p-5 space-y-4">
                <div>
                    <input wire:model.live.debounce.500ms="globalSearchQuery" type="text" class="w-full rounded-md p-2 border-2 border-slate-300 text-lg text-slate-600 placeholder:text-slate-400 focus:ring-sky-600 focus:border-sky-600" placeholder="Enter here...">
                </div>
